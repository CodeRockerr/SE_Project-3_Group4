...
describe('DishCard Component', () => {
  describe('Rendering', () => {
    it('renders the dish card', () => {
      renderWithLanguage(<DishCard index={1} />)
    ...
    it('displays correct dish for index 2', () => {
      renderWithLanguage(<DishCard index={2} />)
    ...
    it('displays correct dish for index 3', () => {
      renderWithLanguage(<DishCard index={3} />)
  ...
  describe('Price Calculation', () => {
    ...
    it('calculates price correctly for index 5', () => {
      renderWithLanguage(<DishCard index={5} />)
  ...
  describe('Card Structure', () => {
    it('has image section and content section', () => {
      const { container } = renderWithLanguage(<DishCard index={1} />)
