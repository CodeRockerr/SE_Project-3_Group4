...
const TRANSLATIONS: Record<SupportedLanguage, Record<string, string>> = {
  en: {
    ...
    "greeting.tagline1": "Track. Log. Succeed.",
    "greeting.tagline2": "Your health journey continues.",
    "greeting.tagline3": "Making healthy choices easy.",
    "greeting.tagline4": "Stay on track, stay motivated.",
    ...
    "item.nutritionDetails": "Nutrition Details",
    "item.ingredients": "Ingredients",
    "item.details": "Details",
    "item.hide": "Hide",
    "item.add": "Add",
    "item.addToToday": "Add to Today",
    ...
    "recommendations.lowProtein": "Your orders are low in protein. Protein helps with satiety and muscle maintenance.",
    "recommendations.lowProteinTip": "💡 Try searching for \"high protein\" or \"at least 30g protein\" options.",
    "recommendations.lowCalories": "Your orders are quite low in calories. Make sure you're getting enough energy!",
    "recommendations.lowCaloriesTip": "💡 Consider adding nutrient-dense items to your orders.",
    "recommendations.frequentRestaurant": "You order from McDonald's frequently. Try exploring other restaurants for variety!",
    "recommendations.frequentRestaurantTip": "💡 Browse different restaurants to discover new healthy options.",
  },
  es: {
    ...
    "greeting.tagline1": "Registra. Documenta. Triunfa.",
    "greeting.tagline2": "Tu viaje de salud continua.",
    "greeting.tagline3": "Haciendo que las opciones saludables sean faciles.",
    "greeting.tagline4": "Mantente en el camino, mantente motivado.",
    ...
    "item.nutritionDetails": "Detalles nutricionales",
    "item.ingredients": "Ingredientes",
    "item.details": "Detalles",
    "item.hide": "Ocultar",
    "item.add": "Agregar",
    "item.addToToday": "Agregar a Hoy",
    ...
    "recommendations.ingredient": "Ingrediente",
    "recommendations.matches": "Coincidencias",
    ...
    "recommendations.lowProtein": "Tus pedidos son bajos en proteina. La proteina ayuda con la saciedad y el mantenimiento muscular.",
    "recommendations.lowProteinTip": "💡 Intenta buscar opciones de \"proteina alta\" o \"al menos 30g de proteina\".",
    "recommendations.lowCalories": "Tus pedidos tienen pocas calorias. Asegurate de obtener suficiente energia.",
    "recommendations.lowCaloriesTip": "💡 Considera agregar articulos densos en nutrientes a tus pedidos.",
    "recommendations.frequentRestaurant": "Ordenas de McDonald's frecuentemente. Intenta explorar otros restaurantes para obtener variedad.",
    "recommendations.frequentRestaurantTip": "💡 Explora diferentes restaurantes para descubrir nuevas opciones saludables.",
  },
};
