...
This guide explains how to build and run the Howl2Go Express API (`Proj_3/Howl2Go_backend`) with the provided production `Dockerfile`. The container installs only runtime dependencies, drops root privileges, and serves the API on port `4000`.
