        ...
        <div className="flex flex-wrap items-center justify-between gap-4 text-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[var(--text-muted)] text-xs">
              {t("footer.openSource", "Open Source")}
            </span>
          </div>

          {/* Team */}
          <div className="flex items-center gap-2 text-[var(--text-subtle)]">
            <span className="text-[var(--text-muted)] text-xs mr-2">{t("footer.team", "Team:")}</span>
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <span className="text-xs">{t("footer.github", "GitHub")}</span>
            </a>
            <a
